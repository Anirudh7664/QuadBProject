...
const UserInfoItem = ({ commonGetRequest, id, authToken }) => {
    ...
    useEffect(() => {
        commonGetRequest(`http://localhost:8000/api/admin/geteuser`, id, setUserData);
        window.scroll(0, 0)
    ...
    const deleteAccount = async () => {
        try {
            const deleteUser = await axios.delete(`http://localhost:8000/api/admin/deleteproduct/${userData._id}`, {
                headers: {
